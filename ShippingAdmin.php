...
class ShippingAdmin extends SC_Plugin_Base {
    ...
    function install($arrPlugin) {
        ...
        if(copy(PLUGIN_UPLOAD_REALDIR . "ShippingAdmin/js/jquery.excolorboxform-0.1.3.js", PLUGIN_HTML_REALDIR . $arrPlugin['plugin_code'] . "/js/jquery.excolorboxform-0.1.3.js") === false) print_r("失敗");
        if(!file_exists(PLUGIN_HTML_REALDIR . $arrPlugin['plugin_code'] . "css"))mkdir(PLUGIN_HTML_REALDIR . $arrPlugin['plugin_code'] . "/css");
        if(copy(PLUGIN_UPLOAD_REALDIR . "ShippingAdmin/css/plg_ShippingAdmin.css", PLUGIN_HTML_REALDIR . $arrPlugin['plugin_code'] . "/css/plg_ShippingAdmin.css") === false) print_r("失敗");
